...
export default function Sidebar() {
  ...
  return (
    <aside className="w-[220px] flex-shrink-0 flex flex-col bg-Chalk-surface border-r border-Chalk-border overflow-hidden animate-slide-left">
        ...
        <div className="flex flex-col gap-px">
          {LANGUAGES.map(lang => (
            <button
              ...
              className={`
                flex items-center gap-2 w-full px-2 py-1.5 rounded text-left text-[12.5px]
                transition-colors duration-100
                ${language === lang.id
                  ? "bg-Chalk-active text-Chalk-primary"
                  : "text-Chalk-secondary hover:bg-Chalk-hover hover:text-Chalk-primary"
                }
              `}
            >
